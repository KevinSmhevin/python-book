...
if len(remainders_3(numbers_1)) > 0:
    print("numbers_1 has number divisble by 3")

if len(remainders_3(numbers_2)) > 0:
    print("numbers_2 has number divisble by 3")
    
if len(remainders_3(numbers_3)) > 0:
    print("numbers_3 has number divisble by 3")
    
if len(remainders_3(numbers_4)) > 0:
    print("numbers_4 has number divisble by 3")
